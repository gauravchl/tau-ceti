...
const Star = ({ size = 30, color = '#FFCD69', ...other }) => {
  return (
    <svg width={size} height={size} viewBox="0 0 30 30" fill="none" {...other}>
      <g filter="url(#filter0_i_23247_9)">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feBlend mode="normal" in2="shape" result="effect1_innerShadow_23247_9" />
        </filter>
      </defs>
    </svg>
  );
